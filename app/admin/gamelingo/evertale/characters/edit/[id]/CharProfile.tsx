    ...
    <div id="character-profil" className={SECTION_STYLE}>
      ...
      <label htmlFor="part-1-en">
        ...
        <textarea
          ...
          defaultValue={character?.charProfile?.part1En}
      ...
      <label htmlFor="part-1-id">
        ...
        <textarea
          className={TEXTAREA_STYLE}
          defaultValue={character?.charProfile?.part1Id}
      ...
      <label htmlFor="part-2-en">
        ...
        <textarea
          className={TEXTAREA_STYLE}
          defaultValue={character?.charProfile?.part2En}
      ...
      <label htmlFor="part-2-id">
        ...
        <textarea
          className={TEXTAREA_STYLE}
          defaultValue={character?.charProfile?.part2Id}
      ...
      <label htmlFor="part-3-en">
        ...
        <textarea
          className={TEXTAREA_STYLE}
          defaultValue={character?.charProfile?.part3En}
      ...
      <label htmlFor="part-3-id">
        ...
        <textarea
          className={TEXTAREA_STYLE}
          defaultValue={character?.charProfile?.part3Id}
