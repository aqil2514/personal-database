...
export default function CharIntro() {
  ...
  return (
    <SectionWrapper>
      ...
      <Textarea forId="gacha-intro-en" label="Gacha Intro EN" data-field="gachaIntroEn" value={data?.charIntro?.gachaIntroEn} onChange={changeHandler} />
      ...
      <Textarea forId="gacha-text-en" label="Gacha Text EN" data-field="gachaTextEn" value={data?.charIntro?.gachaTextEn} onChange={changeHandler} />
      ...
      <Textarea forId="login-text-en" label="Login Text EN" data-field="loginTextEn" value={data?.charIntro?.loginTextEn} onChange={changeHandler} />
      ...
      <Textarea forId="text-1-en" label="Text 1 EN" data-field="text1En" value={data?.charIntro?.text1En} onChange={changeHandler} />

      <Textarea forId="text-1-id" label="Text 1 ID" data-field="text1Id" value={data?.charIntro?.text1Id} onChange={changeHandler} />

      <Textarea forId="text-2-en" label="Text 2 EN" data-field="text2En" value={data?.charIntro?.text2En} onChange={changeHandler} />

      <Textarea forId="text-2-id" label="Text 2 ID" data-field="text2Id" value={data?.charIntro?.text2Id} onChange={changeHandler} />

      <Textarea forId="text-3-en" label="Text 3 EN" data-field="text3En" value={data?.charIntro?.text3En} onChange={changeHandler} />

      <Textarea forId="text-3-id" label="Text 3 ID" data-field="text3Id" value={data?.charIntro?.text3Id} onChange={changeHandler} />

      <Textarea forId="text-4-en" label="Text 4 EN" data-field="text4En" value={data?.charIntro?.text4En} onChange={changeHandler} />
