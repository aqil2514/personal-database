...
export default function CharProfile() {
  ...
  return (
    <SectionWrapper>
      ...
      <Textarea forId="part-1-en" label="Part 1 EN" data-field="part1En" value={data?.charProfile?.part1En} onChange={changeHandler} onKeyDown={(e) => translateHandler(e, data, setData)} />

      <Textarea forId="part-1-id" label="Part 1 ID" data-field="part1Id" value={data?.charProfile?.part1Id} onChange={changeHandler} />

      <Textarea forId="part-2-en" label="Part 2 EN" data-field="part2En" value={data?.charProfile?.part2En} onChange={changeHandler} onKeyDown={(e) => translateHandler(e, data, setData)} />

      <Textarea forId="part-2-id" label="Part 2 ID" data-field="part2Id" value={data?.charProfile?.part2Id} onChange={changeHandler} />

      <Textarea forId="part-3-en" label="Part 3 EN" data-field="part3En" value={data?.charProfile?.part3En} onChange={changeHandler} onKeyDown={(e) => translateHandler(e, data, setData)} />
